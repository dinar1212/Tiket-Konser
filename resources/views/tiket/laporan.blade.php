                        ...
                        @if (count($tikets))
                            @foreach ($tikets as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('checkin.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('checkin.edit', $data->id) }}"
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $data->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $data->id }}" tabindex="-1"
                                                aria-hidden="true">
